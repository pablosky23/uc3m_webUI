...
(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    buildCalendar: function (fromDate, calendar) {
      ...
      var eventContainer = $(
        '<div class="event-container"><div class="close"><img src = "./resources/icons/closeblack.svg"></div><div class="event-wrapper"></div></div>'
      );
    ...
    fillUp: function (x, y) {
      ...
      filler.animate(100, function () {
        elem.find(".event-container").fadeIn();
        filler.hide();
      });
    },
    ...
    empty: function (x, y) {
      ...
      elem.find(".event-container").fadeOut().find(".event").remove();
